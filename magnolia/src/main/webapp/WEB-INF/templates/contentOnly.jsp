          ...
          <div class="row">
            ...
            <div class="col-md-6 col-vlg-4 col-sm-12 ">
              <div class="tiles overflow-hidden full-height tiles-overlay-hover m-b-10 widget-item">
                ...
                <img src="<c:url value="/resources/assets/img/others/9.jpg" /> " data-src="<c:url value="/resources/assets/img/others/9.jpg" /> " data-src-retina="<c:url value="/resources/assets/img/others/rob.jpg" /> " alt="" class="image-responsive-width hover-effect-img">
              </div>
            </div>
