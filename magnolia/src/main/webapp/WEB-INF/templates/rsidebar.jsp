          ...
          <div class="chat-window-wrapper scroller scrollbar-dynamic" id="chat-users">
            ...
            <div class="side-widget">
              ...
              <div class="side-widget-content" id="friends-list">
                <div class="user-details-wrapper" data-chat-status="online" data-chat-user-pic="<c:url value="/resources/assets/img/profiles/d.jpg" /> " data-chat-user-pic-retina="<c:url value="/resources/assets/img/profiles/d2x.jpg" /> " data-user-name="Jane Smith">
                  <div class="user-profile">
                    <img src="<c:url value="/resources/assets/img/profiles/d.jpg" /> " alt="" data-src="<c:url value="/resources/assets/img/profiles/d.jpg" /> " data-src-retina="<c:url value="/resources/assets/img/profiles/d2x.jpg" /> " width="35" height="35">
                  </div>
                  <div class="user-details">
