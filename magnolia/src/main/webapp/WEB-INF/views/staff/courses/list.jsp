		                    	...
		                    	<c:forEach items="${oneStudentCourses}" var="oneStudentCourse">
			                      ...
			                      <tr>
			                        ...
			                        <td class="text-center">
                                       <div class="btn-group">
                                         <a href="${register}"><button class="btn btn-xs btn-default" type="submit" formmethod="get" formaction="${register}" data-toggle="tooltip" title="Register Course"><i class="fa fa-plus-circle"></i></button></a>
