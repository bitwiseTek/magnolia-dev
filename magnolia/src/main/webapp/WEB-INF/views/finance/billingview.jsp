...
<div align="left" class="container">
	<div align="left" class="login-container animated fadeInUp">
		...
		<form:form class="animated fadeIn validate" id="bill" modelAttribute="bill">
        	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">	
              	<div class="col-md-2 col-sm-2">
           		...
           		<div class="col-md-10 col-sm-10">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	               	...
	               	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
						...
						<div class="col-md-6 col-sm-6">
		                	...
		                	<form:select id="statement" path="statement" style="width:100%" disabled="true">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  <spring:url value="/students/billing/status" var="back"></spring:url>
	                  <div class="col-md-1 col-sm-1">
	                  	<a href="${back}"><button class="btn btn-success btn-cons" type="submit" formmethod="get" formaction="${back}">
