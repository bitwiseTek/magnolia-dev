              	...
              	<div class="col-md-2 col-sm-2">
           		...
           		<div class="col-md-10 col-sm-10">
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                    ...
	                    <label for="username" class="form-control">${student.user.username}</label>
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                  	...
	                  	<label for="studentId" class="form-control">${student.studentId}</label>
	                    <form:input class="form-control" id="studentId" name="studentId" placeholder="Student ID" path="studentId" type="hidden" />
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                  		<label for="endReason" class="control-label">Study End Reason:</label>
	                  		<form:select id="endReason" path="studyEndReason" style="width:100%">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                	<div class="col-md-6 col-sm-6">
	                  		...
	                  		<form:select id="dept" path="studentDepartment.departmentId" style="width:100%; font-weight: 0; font-size: 12px;" disabled="true">
