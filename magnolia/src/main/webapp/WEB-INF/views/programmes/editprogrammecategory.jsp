...
<div align="left" class="container">
	<div align="left" class="login-container animated fadeInUp">
		...
		<form:form class="animated fadeIn validate" method="PUT" id="category" modelAttribute="category">
			<input type="hidden" name="_method" value="PUT" />
        	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
           		<div class="col-md-10 col-sm-10">
           			<div class="row">
           				<h3 align="left" class="appTitle"><span class="lsf-icon" title="category"><spring:message code="categories.edit.category.new" arguments="${category.name}" /></span></h3>
        				<div>&nbsp;</div>
           			</div>
              		<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
		                <div class="col-md-12">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                  	<label for="name" class="control-label"><spring:message code="categories.edit.category.name" /></label>
		                <form:input class="form-control" id="name" path="name" placeholder="Enter Category Name" />
	                  </div>
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  	...
	                  	<div class="col-md-1 col-sm-1">
	                  		<button class="btn btn-danger btn-cons">
		                  		<div class="lsf-icon" title="edit"><spring:message code="categories.edit.category.button" /></div>
		               		</button>
	                  	</div>
	                </div>
              	</div>
