                      	...
                      	<c:if test="${not empty users}">
                      		<c:forEach items="${users}" var="user">
								...
								<c:if test="${user.username == pageContext.request.userPrincipal.name}">
			                        <a href="${editSystemUser}"><button type="button" class="btn btn-danger btn-small" type="submit" formmethod="get" formaction="${editSystemUser}"><i class="fa fa-edit"></i>&nbsp;&nbsp;<spring:message code="users.systemUsers.button.edit" /></button></a>
			                        <a href="${updatePassword}"><button type="button" class="btn btn-primary btn-small" type="submit" formmethod="get" formaction="${updatePassword}"><i class="fa fa-lock"></i>&nbsp;&nbsp;<spring:message code="users.systemUsers.button.updatePassword" /></button></a>
		                        </c:if>
	                        </c:forEach>
                        </c:if>
                      </div>
	                    ...
	                    <div class="col-md-8 user-description-box  col-sm-8">
	                    	<c:forEach items="${users}" var="user">
	                    		<c:if test="${user.username == pageContext.request.userPrincipal.name}">
			                      ...
			                      <br>
			                      <p><i class="fa fa-map-marker"></i>${user.state.name}</p>
			                      <p><i class="fa fa-phone"></i>${user.primaryNumber}</p>
			                      <p><i class="fa fa-envelope"></i>${user.primaryEmail}</p>
