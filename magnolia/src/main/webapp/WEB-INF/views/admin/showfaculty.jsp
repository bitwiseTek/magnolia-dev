...
<div align="left" class="container">
	<div align="left" class="login-container animated fadeInUp">
		...
		<form:form class="animated fadeIn validate" id="faculty" modelAttribute="faculty">
        	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
           		<div class="col-md-10 col-sm-10">
           			<div class="row">
           				<h3 align="left" class="appTitle"><span class="lsf-icon" title="rss"><spring:message code="faculties.show.faculty.new" arguments="${faculty.name}" /></span></h3>
        				<div>&nbsp;</div>
           			</div>
              		<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
		                <div class="col-md-12">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                  	<label for="name" class="control-label"><spring:message code="faculties.show.faculty.name" /></label>
		                <form:input class="form-control" id="name" path="name" placeholder="Enter Faculty Name" disabled="true" />
	                  </div>
	                  
	                  <div class="col-md-6 col-sm-6">
	                  		<label for="camp" class="control-label"><spring:message code="faculties.show.faculty.camp" /></label>
	                  		<form:select id="camp" path="campus.campusId" style="width:100%; font-weight: 0; font-size: 12px;" disabled="true">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                	<spring:url value="/admin/faculties/list" var="back"></spring:url>
	                  	<div>&nbsp;</div>
	                  	<div class="col-md-1 col-sm-1">
	                  		<a href="${back}"><button class="btn btn-info btn-cons" type="submit" formmethod="get" formaction="${back}">
		                  		<div class="lsf-icon" title="left"><spring:message code="faculties.show.faculty.button" /></div>
		               		</button></a>
	                  	</div>
	                </div>
              	</div>
