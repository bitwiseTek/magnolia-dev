...
<div align="left" class="container">
	<div align="left" class="login-container animated fadeInUp">
		...
		<form:form class="animated fadeIn validate" method="PUT" id="faculty" modelAttribute="faculty">
			<input type="hidden" name="_method" value="PUT" />
        	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
           		<div class="col-md-10 col-sm-10">
           			<div class="row">
           				<h3 align="left" class="appTitle"><span class="lsf-icon" title="rss"><spring:message code="faculties.edit.faculty.new" arguments="${faculty.name}" /></span></h3>
        				<div>&nbsp;</div>
           			</div>
              		<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
		                <div class="col-md-12">
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  ...
	                  <div class="col-md-6 col-sm-6">
	                  	<label for="name" class="control-label"><spring:message code="faculties.edit.faculty.name" /></label>
		                <form:input class="form-control" id="name" path="name" placeholder="Enter Faculty Name" type="text" />
	                  </div>
	                  
	                  <div class="col-md-6 col-sm-6">
	                  		<label for="camp" class="control-label"><spring:message code="faculties.edit.faculty.camp" /></label>
	                  		<form:select id="camp" path="campus.campusId" style="width:100%; font-weight: 0; font-size: 12px;">
			                		<c:if test="${not empty campuses}">
				                      	<c:forEach items="${campuses}" var="campus">
				                      	 	<form:option value="${campus.campusId}">${campus.name}</form:option>
				                      	</c:forEach>
			                      </c:if>
							</form:select>
							<form:errors class="error" path="campus.campusId" />
	                  </div>
	                </div>
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	               	...
	               	<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                	<div class="col-md-6 col-sm-6">
	                  		...
	                  		<label for="createdAt" class="form-control">${faculty.createdAt}</label>
	                  	...
	                  	<div class="col-md-6 col-sm-6">
	                  		...
	                  		<label for="createdAt" class="form-control">${faculty.updatedAt}</label>
	                ...
	                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
	                  	...
	                  	<div class="col-md-1 col-sm-1">
	                  		<button class="btn btn-danger btn-cons">
		                  		<div class="lsf-icon" title="edit"><spring:message code="faculties.edit.faculty.button" /></div>
		               		</button>
	                  	</div>
	                </div>
              	</div>
