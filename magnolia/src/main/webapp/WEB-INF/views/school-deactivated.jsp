...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Magnolia - School Deactivated</title>
  ...
  <body class="error-body no-top">
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-offset-1 col-xs-10">
          <div class="error-container">
            <div class="error-main">
              <div class="error-number"><img src="<c:url value="/resources/assets/img/school-deactivated.jpeg" /> " /> </div>
             <!-- <div class="error-description"> The school you're trying access does not exist. </div>-->
              <div class="error-description-mini"> The page your looking for is not active at the moment... Pls check back again </div>
              <br>
    ...
    <div id="footer">
      <div class="error-container">
        <div class="copyright"> All work copyright of respective owner, 2017 bitwise Incorporated </div>
      </div>
    </div>
    <!-- END CONTAINER -->
